...
var menu1 = [ {'Highlight':function(menuItem,menu) { mark(); } }, $.contextMenu.separator, {'Delete this node':function(menuItem,menu) { alert("You clicked Option 2!"); } } ]; $(function() { $('.node').contextMenu(menu1,{theme:'vista'}); });
